...
- Realtime / 2 Replica / Reconnect 강화 검증 — `seokpan-app#112`
...
- `seokpan-app#112` — F07 cross-Pod replacement, F08 connected lifecycle, Safe Leave/Reconnect, Realtime presentation의 실제 2-Pod/Provider/Browser 강화 검증
