...
47. **[TS-047 — 초기 VM의 과거 DNS Search Domain 설정이 Pod DNS Search Path까지 남아 있던 문제](TS-047_초기_VM_DNS_Search_Domain_잔존.md)**
48. **[TS-048 — Ansible Vault의 DB Credential이 MariaDB·Kubernetes Secret과 달라진 문제](TS-048_Ansible_Vault_DB_Credential_불일치.md)**
